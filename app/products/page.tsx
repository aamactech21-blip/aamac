...
export const metadata: Metadata = {
  title: 'Item for Sale | AAMAC Technology',
  description:
...
async function getProducts(): Promise<Product[]> {
  try {
    return await sanityWriteClient.fetch(
      `*[_type == "product"] | order(_createdAt desc) { _id, name, description, price, "imageUrl": image.asset->url }`
    )
  } catch {
    return []
  }
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              <div className="max-w-2xl">
                ...
                <h1 className="text-5xl md:text-6xl font-extrabold text-white text-balance leading-tight mb-5">
                  Item for{' '}
                  <span className="font-accent-italic text-[#E63946]">Sale</span>
                </h1>
